...
extern u8 Flag;//是否报警的标志
extern u8 Free;

#define PROID		"621774"  //产品id

#define AUTH_INFO	"flyfish"   //鉴权信息

#define DEVID		"1169393466"  //设备id
		...
		case MQTT_PKT_PUBLISH:														//接收的Publish消息
			...
			if(result == 0)
			{
				...
				else
				{
					...
					{
						json_value=cJSON_GetObjectItem(json,"value");
						if(json_value->valueint)Flag=1;
						else Flag = 0;
						Free=0;//上位机控制和手动控制具有一样的优先级，优先于自动控制，所以要把Fr归0
					}
